...
reports_dir = sys.argv[1] + "/cts"

file_path1  = reports_dir + "/11-cts_sta.clock_skew.rpt"
file_path2  = reports_dir + "/11-cts_sta.max.rpt"
file_path3  = reports_dir + "/11-cts_sta.min.rpt"
file_path4  = reports_dir + "/11-cts_sta.rpt"
file_path5  = reports_dir + "/11-cts_sta.tns.rpt"
file_path6  = reports_dir + "/11-cts_sta.wns.rpt"
file_path7  = reports_dir + "/13-cts_rsz_sta.area.rpt"
file_path8  = reports_dir + "/13-cts_rsz_sta.clock_skew.rpt"
file_path9  = reports_dir + "/13-cts_rsz_sta.max.rpt"
file_path10 = reports_dir + "/13-cts_rsz_sta.min.rpt"
file_path11 = reports_dir + "/13-cts_rsz_sta.power.rpt"
file_path12 = reports_dir + "/13-cts_rsz_sta.rpt"
file_path13 = reports_dir + "/13-cts_rsz_sta.slew.rpt"
file_path14 = reports_dir + "/13-cts_rsz_sta.tns.rpt"
file_path15 = reports_dir + "/13-cts_rsz_sta.wns.rpt"
file_path16 = reports_dir + "/13-cts_rsz_sta.worst_slack.rpt"

summary_path = os.path.join(reports_dir, "cts_summary.rpt")
...
with open(summary_path, "w") as f:
    f.write("=" * 70 + "\n")
    f.write(f"CTS Timing Summary Report - Generated {datetime.now()}\n")
    f.write("=" * 70 + "\n\n")

    f.write(f"{'Metric':<25}{'Before Opt (CTS)':<25}{'After Opt (Resize)':<25}\n")
    f.write("-" * 70 + "\n")
