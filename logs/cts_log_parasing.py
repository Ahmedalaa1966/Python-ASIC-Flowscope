...
logs_dir = sys.argv[1] + "/cts"

file_path1 = logs_dir + "/11-cts.log"
file_path2 = logs_dir + "/12-write_verilog.log"
file_path3 = logs_dir + "/13-resizer.log"
file_path4 = logs_dir + "/14-write_verilog.log"
