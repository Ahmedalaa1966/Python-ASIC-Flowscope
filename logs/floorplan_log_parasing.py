...
logs_dir = sys.argv[1] + "/floorplan"

file_path1 = logs_dir + "/3-initial_fp.log"
file_path2 = logs_dir + "/4-place_io_ol.log"
file_path3 = logs_dir + "/5-tap.log"
file_path4 = logs_dir + "/6-pdn.log"
