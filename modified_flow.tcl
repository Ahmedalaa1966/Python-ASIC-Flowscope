...
proc run_non_interactive_mode {args} {
    ...
    set result [exec python3 /home/icpedia/ahmed_alaa/python/reports/run_all_reports.py $reports_path]
    puts_info "$result"
    }
    proc run_all_logs_step {args} {
    puts_info "Running log parsing scripts..."
    set logs_path $::env(RUN_DIR)/logs
    set result [exec python3 /home/icpedia/ahmed_alaa/python/log/run_all_log_parsers.py $logs_path]
    puts_info "$result"
    }
